...
public class MovingTarget03 {
    public static void main(String[] args) {
        ...
        while (!input.equals("End")) {
            String[] testComands = input.split(" ");
            String command1 = testComands[0];
            int command2 = Integer.parseInt(testComands[1]);
            int command3 = Integer.parseInt(testComands[2]);
